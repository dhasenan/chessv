...
{
  public partial class ArchipelagoLobbyControl : UserControl
  {
    private Game game;
    private Color[] pieceColors;
    private List<KeyValuePair<int, double>> evaluations;

    public ArchipelagoLobbyControl()
    {
      InitializeComponent();
    }
    ...
    private void ArchipelagoLobbyControl_Paint(object sender, PaintEventArgs e)
    {
